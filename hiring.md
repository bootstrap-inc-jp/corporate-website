...
コンテンツ企業のインターネットサービスの運営代行をおこなう会社です。キャラクターや漫画・小説などの作品を扱う会社のことをIPホルダーや出版社といいますが、彼らにはインターネットを通じて作品を届けるサービスづくりが求められています。ここ10年で作品は紙よりもネットの方が多く読まれる時代へと大きく変化し、Webやアプリを自分たちで運営し作品を届ける必要に迫られています。

我々は、ピクシブやドワンゴをはじめとしてインターネットでコンテンツサービスを運営してきた専門家たちの集まりです。コンテンツ企業に対して、事業デザイナーやプロダクトマネジャーは事業の企画段階からガッツリと関わり、技術者たちによるソフトウェアの開発と保守、そしてカスタマーサポートやオペレーターによるサービス運用に至るまで、すべてをワンストップでお手伝いしています。

# 求める人材像

**人々を楽しませるために専門性を活かしたい、という方**

弊社では二次請けやSESといったソフトウェア受託の業態は一切行いません。ITエンジニアやカスタマーサクセスといったサービス運営の専門人材を持たないIPホルダー・出版社が、ネットでサービスを運営できるようにお手伝いする **"サービス運営の代行"** であることに強いこだわりを持ちます。サービスに必要となる事業企画から現場のオペレーションに至るまで、あらゆる活動をカバーし密に運営へ関わっていくことをモットーとしています。

取り扱っている技術はNext.js・TS・AWS・GCPといった新しいものを取り扱っていはいますし、技術者はみなテクノロジーの専門家であるというプライドを持っています。しかし、我々は技術に特化した専門会社というわけではありませんので、ソフトウェアで頂点を目指したいという方向性でキャリア実現を目指す方にはやや不足が感じられるかもしれません。一方で、作品のファンを楽しませるようなプロダクトづくりであったり、Webやアプリのサービス運営の全体像をガッツリと経験していきたいという方にとっては、大変多くの機会に恵まれます。

自身の持っている専門性を活用して、クリエイターたちが必死になって生み出してきた作品を届けるお手伝いをしたい。それも、IPホルダーや出版社のお膝元でそういったチャレンジを行っていただきたいという方は、ぜひ我々と共にその想いを実現させてください。
