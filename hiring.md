...
現在、3つの案件が同時並行で動いていますが、一番大きなのはキャラクタービジネス業界最王手であるS社のサービス開発です。実質的にはS社さま専用の開発会社みたいになっています。初年度は大手企業を中心にいくつかの実績を作りたいと考え、S社さま以外にも出版社へ企画の提案を行う予定ではありましたが、結果としてはいくつかの編集部と小さな実績を作る程度にとどまりました。
